...
export const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="w-full px-6 lg:px-10 xl:px-16 flex justify-between items-center mx-auto max-w-[1920px]">
        <motion.div
          initial={{ opacity: 0, x: -20 }}
          animate={{ opacity: 1, x: 0 }}
          className={`text-xl xl:text-2xl font-black tracking-tighter flex items-center gap-2 transition-transform ${glitchTitle ? 'scale-110 skew-x-3 filter invert-[0.1]' : ''}`}
        >
          <img src="/logo.svg" alt="FP Logo" className="w-8 h-8 xl:w-10 xl:h-10 drop-shadow-[0_0_8px_rgba(6,182,212,0.8)]" />
        ...
        <div className="hidden lg:flex items-center gap-4 xl:gap-8">
          {['about', 'projects', 'skills', 'certifications', 'contact'].map((item) => (
            <a
              ...
              className={`text-[10px] xl:text-xs font-bold uppercase tracking-widest transition-colors ${item === 'contact'
